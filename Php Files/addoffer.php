...
$sql="SELECT * FROM request_advertisement";
  ...
  <tbody>
    <tr>
      <th scope="row "><?php echo $product["add_id"]?></th>
     
      
      <td><?php echo $product["M_name"]?></td>
      <td><?php echo $product["M_generic"]?></td>
      
      <td><?php echo $product["M_privious_price"]?></td>
    <td><?php echo $product["M_price"]?></td>
    <td><?php echo $product["add_Date"]?></td>
     
      <td><a class="btn btn-dark" href="insertadd.php?id=<?php echo $product["add_id"]?>" role="button">add</a>
      <a class="btn btn-dark" href="deleteadd.php?id=<?php echo $product["add_id"]?>" role="button">delete</a>
