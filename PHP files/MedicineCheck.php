    ...
    <a href="index.php"><header>MEDIFIND</header></a>
         ...
         <li><a href="DashboardShop.php"><i class="fa fa-qrcode"></i><?php echo $_SESSION["username"]?></a></li>
             ...
             <li><a href="Logout.php"><i class="fa fa-tasks"></i>LogOut </a></li>
                     ...
                     <form class="row" action="MedicineCheck.php" method="get">
  <div class="col-2">
...
<table class="table text-dark ">
  ...
  if(isset($_GET['medicine'])){
    ...
    $sql="select*
    from
    (SELECT `M_id`, `shop_id`, `stocks` FROM `medicine_shop` WHERE shop_id='{$_SESSION["id"]}' and M_id=ANY(select M_id from medicine where M_name like '%$a' or M_generic like '%$a')and stocks>0) as c join medicine 
    ON c.M_id=medicine.M_id";
