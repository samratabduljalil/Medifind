...
<?php
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Price Shop</th>
      <th scope="col">Price customers</th>
...
$sql="SELECT * FROM `request_medicine`";
  ...
  <tbody>
    <tr>
      <th scope="row "><?php echo $product["request_id"]?></th>
      <td><?php echo $product["M_name"]?></td>
      <td><?php echo $product["M_generic"]?></td>
      <td><?php echo $product["M_price_shop"]?></td>
      <td><?php echo $product["M_price_customers"]?></td>
    <td><?php echo $product["request_Date"]?></td>
     
      <td><a class="btn btn-dark" href="requestDetailsmedicine.php?id=<?php echo $product["request_id"]?>" role="button">Reviw</a></td>
                     </tr>
