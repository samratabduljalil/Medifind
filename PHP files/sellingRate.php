...
<?php
  ...
  <head>
    ...
    <a href="index.php"><header>MEDIFIND</header></a>
        ...
        <form class="row" action="sellingRate.php" method="get">
  <div class="col-3">
  ...
  <div class="col-3">
    ...
    <input type="Search"placeholder="Search" name="district">
  </div>
  ...
  <br><br><br><br>
  <div class="col-11">
  <button type="submit" class="btn btn-dark">Selling rate</button></div>
</form>
...
<table class="table text-dark ">
  <thead>
    <tr>
      <th scope="col">Medicine generic</th>
...
<?php 
    ...
    $a=$_GET['generic'];
    $b=$_GET['district'];
    $sql="select Sum(Shop_Buy) from medicine_shop_buy where M_id=ANY(select M_id 
    from medicine
    where M_generic='$a') and shop_id=ANY(select shop_id from medical_shop where S_district='$b')";
...
?>
  ...
  <tbody>
    <tr>
      <td><?php  echo $_GET['generic']?></td>
      
      <td><?php echo $_GET['district']?></td>
      <td><?php $E=0; echo $E+$product["Sum(Shop_Buy)"]?> pices</td>
