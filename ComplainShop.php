...
<?php
  ...
  <head>
    ...
    <a href="index.php"><header>MEDIFIND</header></a>
        ...
        <form class="row" action="ComplainShop.php" method="get">
  <div class="col-3">
  ...
  <div class="col-3">
    ...
    <input type="Search"placeholder="Search" name="company">
  </div>
...
<?php 
    ...
    (select *
    from medicine
    where company_id=(select company_id from company where C_name='$b') and   M_generic=(select M_generic from medicine where M_name='$a'))as new join company
    ON new.company_id=company.company_id";
...
?>
  ...
  <tbody>
    ...
    <td><?php  echo $product['M_name']?></td>
      ...
      <td><?php $E=0; echo $E+$product["M_price"]?> </td>
